...
class Controller_Core_Action
{
	...
	public function setMessage(Model_Core_Request $message)
	{
	...
	public function redirect($controller=null, $action=null, array $param=null,$reset = false,$url=null)
	{
		if($url == null){
			$url = $this->getUrl()->getUrl($controller, $action, $param, $reset);
		}
		header("location: {$url}");
		exit();
	}
